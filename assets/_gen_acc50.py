...
def gl_round():
    img = new()
    for cx in [10, 21]:
        rect(img, cx-3, 14, cx+3, 18, (150,200,240,180))
        hline(img, cx-3, cx+3, 13, (40,40,50,255))
        hline(img, cx-3, cx+3, 19, (40,40,50,255))
        vline(img, cx-4, 14, 18, (40,40,50,255))
        vline(img, cx+4, 14, 18, (40,40,50,255))
...
def gl_square():
    img = new()
    for x in [3, 17]:
        rect(img, x, 13, x+10, 19, (150,200,240,180))
        rect(img, x, 13, x+10, 13, (40,40,50,255))
        rect(img, x, 19, x+10, 19, (40,40,50,255))
        vline(img, x, 13, 19, (40,40,50,255))
        vline(img, x+10, 13, 19, (40,40,50,255))
...
def gl_sun():
    img = new()
    for x in [3, 17]:
        rect(img, x, 13, x+10, 19, (40,40,50,255))
    hline(img, 13, 18, 16, (40,40,50,255))
    return img

def gl_monocle():
    img = new()
    rect(img, 17, 14, 23, 19, (150,200,240,180))
    hline(img, 17, 23, 13, (40,40,50,255))
    hline(img, 17, 23, 20, (40,40,50,255))
    vline(img, 16, 14, 19, (40,40,50,255))
    vline(img, 24, 14, 19, (40,40,50,255))
    vline(img, 14, 16, 24, (245,210,80,255))  # chain
    return img

def gl_heart():
    img = new()
    for cx in [10, 21]:
        for (dx, dy) in [(-2,0),(-1,0),(0,0),(1,0),(2,0),(-1,1),(0,1),(1,1),(0,2)]:
...
def gl_star():
    ...
    for cx in [10, 21]:
        # 5-point simplified
        rect(img, cx-1, 14, cx+1, 16, (245,210,80,255))
        px(img, cx-2, 15, (245,210,80,255)); px(img, cx+2, 15, (245,210,80,255))
        px(img, cx, 13, (245,210,80,255))
    return img

def gl_mask():
    img = new()
    rect(img, 7, 17, 24, 23, (255,255,255,255))
    rect(img, 7, 17, 24, 18, (200,200,210,255))
    return img

def gl_eyepatch():
    img = new()
    rect(img, 6, 13, 14, 20, (40,40,50,255))
    vline(img, 14, 13, 20, (40,40,50,255))
    rect(img, 14, 16, 28, 17, (40,40,50,255))  # strap
    return img
